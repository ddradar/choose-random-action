...
- まだ作業中である場合、Draft Pull Request で送信してください。マージ可能になったら、Ready for Review に変更してください。
  - 作業中に main ブランチが変更された場合は、競合を解消してから Ready for Review に変更してください。
  - その作業を予約する意味で、まず Draft Pull Request を投稿しても構いません。ただし、長い間活動が見られない場合は、クローズされる場合があります。
